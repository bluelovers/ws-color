...
declare namespace chroma {
    ...
    interface ChromaStatic {
         ...
         */
        mix(color1: string | Color, color2: string | Color, f?: number, colorSpace?: keyof IColorSpaces): Color;

        /**
         * Alias for {@see mix}.
         */
        interpolate(color1: string | Color, color2: string | Color, f?: number, colorSpace?: keyof IColorSpaces): Color;

        /**
         * Similar to {@link mix}, but accepts more than two colors. Simple averaging of R,G,B components and the alpha
         * channel.
         */
        average(colors: Array<string | Color>, colorSpace?: keyof IColorSpaces): Color;
         ...
         */
        distance(color1: string | Color, color2: string | Color, colorSpace?: keyof IColorSpaces): number;
    ...
    interface Color {
         ...
         */
        luminance(l: number, colorSpace?: keyof IColorSpaces): Color;
    ...
    interface Scale<OutType = Color> {
        ...
        out<K extends keyof IColorSpaces>(format: K): Scale<IColorSpaces[K]>;
